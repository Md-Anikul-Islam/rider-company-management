                                    ...
                                    <td>
                                       <div class="btn-group dropstart action_button_wrapper">
                                           ...
                                           <ul class="dropdown-menu action_dropdown_menu">
                                               <li>
                                                   <a class="dropdown-item" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#modalFormDataEdit{{$fleetTypeData->id}}"><i class="fa-solid fa-edit"></i> Edit</a>
                                               </li>
                                               <li>
                                                  <a class="dropdown-item" href="{{route('admin.fleetType.delete',$fleetTypeData->id)}}"  data-bs-toggle="modal" data-bs-target="#deleteModal{{$fleetTypeData->id}}" data-category-id="{{$fleetTypeData->id}}"><i class="fa-solid fa-trash"></i> Delete</a>
                                               </li>
                                           </ul>
                                       </div>
                                    </td>
