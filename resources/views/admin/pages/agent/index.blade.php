                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalFormDataEdit{{$agentData->id}}">Edit</button>
                                        <a href="{{route('admin.agent.delete',$agentData->id)}}" class="btn btn-danger btn-sm delete-division" data-bs-toggle="modal" data-bs-target="#deleteModal{{$agentData->id}}" data-category-id="{{$agentData->id}}">Delete</a>
                                    </td>
                                </tr>
